...
const HowItWorks = () => {
    const steps = [
        ...
        },
        {
            ...
            description: 'Agrovia processes weather data, regional patterns, and agricultural knowledge to understand your situation.',
            icon: (
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Container>
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-charcoal-light max-w-2xl mx-auto">
                        Getting started with Agrovia takes just a few minutes.

                    ...
                    <div className="max-w-3xl mx-auto prose prose-lg">
                        ...
                        <div className="mb-10">
                            ...
                            <p className="text-charcoal-light leading-relaxed">
                                Welcome to FarmGuide. By using our platform, you agree to these terms.
                                FarmGuide is an AI-powered service that provides farming guidance and
                        ...
                        <div className="mb-10">
                            ...
                            <p className="text-charcoal-light leading-relaxed">
                                FarmGuide is designed for informational purposes. You may use our platform
                        ...
                        <div className="mb-10">
                            ...
                            <p className="text-charcoal-light leading-relaxed">
                                While we strive to provide helpful and accurate information, FarmGuide
                        ...
                        <div className="mb-10">
                            ...
                            <p className="text-charcoal-light leading-relaxed">
                                ...
                                this data solely to enhance your experience and improve FarmGuide. We do
                        ...
                        <div className="mb-10">
                            ...
                            <p className="text-charcoal-light leading-relaxed">
                                FarmGuide is an evolving platform. As we grow and learn, our service may
                        ...
                        <div className="mb-10">
                            ...
                            <p className="text-charcoal-light leading-relaxed">
                                As FarmGuide evolves, these terms may be updated. We will make reasonable
